...
contract LotteryContract is ReentrancyGuard, ILottery, Ownable {
    ...
    uint256 public maximumTicketPrice = 50 ether;
    uint256 public minimumTicketPrice = 0.000000000000000005 ether;
    ...
    function recoverWrongTokens(
        ...
        require(tokenAddress != address(lotteryToken), "Cannot be LZN token");
